    ...
    return (
      <div className="service-logs" style={{flexGrow: "1", paddingTop: "15px", paddingLeft: "15px", paddingBottom: "0px", paddingRight: "0px", display: "flex", flexDirection: "column", flex: "2", position: 'relative'}}>
        ...
        <div style={{position: 'absolute', top: '5', right: '5'}}>
          <button type="button" className="compose-control" onClick={this.props.reload}>Reattach</button>
          <button type="button" className="compose-control" onClick={this.props.stop}>Detach</button>
        </div>
      </div>
    );
  }
