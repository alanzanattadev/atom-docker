...
export default React.createClass({
  ...
  render: function() {
    return (
      <div style={{padding: "15px", display: "flex", flexDirection: "column", alignSelf: "stretch"}}>
        <div style={{width: "400px", display: "flex", flexDirection: "row", justifyContent: "flex-end"}}>
          <ServiceControls
